...
-- Создание схем для исходных и учебных данных.
CREATE SCHEMA IF NOT EXISTS olist;
CREATE SCHEMA IF NOT EXISTS lab;

-- Создание таблиц исходного набора данных Olist.
...
-- Импорт девяти CSV-файлов с компьютера клиента psql.
...
-- Добавление первичных ключей после загрузки CSV.
...
-- Добавление внешних ключей после загрузки CSV.
...
-- Сбор статистики по всем таблицам схемы olist.
